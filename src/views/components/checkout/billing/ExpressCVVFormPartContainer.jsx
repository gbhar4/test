/**
* @module ExpressCVVFormPartContainer
*
...
class _ExpressCVVFormPart extends React.Component {
  static propTypes = {
...
let ExpressCVVFormPartContainer = isMobileConnect(_ExpressCVVFormPart);
ExpressCVVFormPartContainer.defaultValidation = getStandardConfig(['cvv']);
export {ExpressCVVFormPartContainer};

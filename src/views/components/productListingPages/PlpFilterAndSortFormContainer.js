...
import {PlpFilterAndSortForm, formName} from './PlpFilterAndSortForm.jsx';
...
export let PlpFilterAndSortFormContainer = connectPlusStoreOperators(
  {productsFormOperator: getProductsFormOperator}, mapStateToProps
)(PlpFilterAndSortForm);
